...
const OCCUPATIONS = [
  "Employed", "Self-Employed", "Business Owner", "Government",
  "Student", "Retired", "Unemployed", "Driver/Transport"
];
...
function Field({ label, error, hint, children }) {
  return (
    <div style={{ marginBottom: 14 }}>
      <label style={{ fontSize: 13, fontWeight: 600, color: "#334155", display: "block", marginBottom: 5 }}>
        {label}
      </label>
      {children}
...
function VehicleModelInput({ value, onChange, onTypeChange, error }) {
...
function ShapPanel({ explanation, title = "🧠 Risk Drivers (SHAP)" }) {
  ...
  return (
    <div style={{ background: "#f8fafc", borderRadius: 10, padding: "14px 16px", marginTop: 12 }}>
      <div style={{ fontWeight: 700, fontSize: 13, color: "#0f172a", marginBottom: 10 }}>{title}</div>
          ...
          <div key={i} style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 9 }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 3, gap: 10 }}>
                <span style={{ fontSize: 12, fontWeight: 600, color: "#0f172a" }}>{d.feature}</span>
                <span style={{ fontSize: 11, color: "#64748b", textAlign: "right" }}>{d.reason}</span>
              </div>
      ...
      {drivers.length > 6 && (
        <div style={{ marginTop: 6, fontSize: 11, color: "#64748b" }}>
          Showing top 6 drivers out of {drivers.length}.
        </div>
      )}
    </div>
  );
      ...
      <div style={{ display: "flex", gap: 8, marginBottom: 24 }}>
        {["Customer Details", "Vehicle & Coverage", "Result"].map((s, i) => (
          <div key={i} style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <span style={{ fontSize: 13, fontWeight: step === i ? 700 : 400, color: step === i ? "#2563eb" : "#64748b" }}>
              {s}
            </span>
      ...
      {step === 0 && (
        <div style={{ background: "#fff", borderRadius: 12, padding: 24, boxShadow: "0 1px 4px rgba(0,0,0,.06)", maxWidth: 720 }}>
          ...
          <div style={{ marginTop: 20, display: "flex", justifyContent: "flex-end" }}>
            <button
              onClick={goNext}
              style={{ padding: "11px 28px", borderRadius: 8, border: "none", background: "#2563eb", color: "#fff", fontWeight: 700, fontSize: 14, cursor: "pointer" }}
            >
              Next: Vehicle Info ›
            </button>
          </div>
      ...
      {step === 1 && (
        <div style={{ background: "#fff", borderRadius: 12, padding: 24, boxShadow: "0 1px 4px rgba(0,0,0,.06)", maxWidth: 800 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 16 }}>
            ...
            <Field
              label="Sum Insured (LKR) *"
              error={errs.sum_insured}
            ...
            >
              ...
              {siSuggested && (
                <button
                  type="button"
                  onClick={() => set("sum_insured", String(siSuggested.suggested))}
                  style={{
                    marginTop: 4,
                    padding: "3px 10px",
                    borderRadius: 6,
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20, maxWidth: 900 }}>
          ...
          <div style={{ background: "#fff", borderRadius: 12, overflow: "hidden", boxShadow: "0 1px 8px rgba(0,0,0,.08)" }}>
            ...
            <div style={{ padding: "16px 20px" }}>
              {[
                ...
                <div
                  ...
                  style={{
                    ...
                    fontSize: 13,
                    color: i === 6 ? "#0f172a" : String(v).startsWith("–") ? "#16a34a" : "#334155"
                  }}
                >
              ...
              {/* ✅ SHAP explanation near premium calculation */}
              <ShapPanel explanation={result.explanation} title="🧠 Key drivers affecting premium / risk" />
          ...
          <div style={{ background: "#fff", borderRadius: 12, padding: 20, boxShadow: "0 1px 8px rgba(0,0,0,.08)" }}>
            ...
            {/* ✅ SHAP explanation near risk score */}
            <ShapPanel explanation={result.explanation} title="🧠 Why this risk score?" />
              ...
              <div style={{ marginTop: 16, display: "flex", gap: 10 }}>
                <button
                  ...
                  style={{
                    ...
                    borderRadius: 8,
                    border: "none",
                    background: issuing ? "#94a3b8" : "#16a34a",
                    color: "#fff",
                    fontWeight: 700,
